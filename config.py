...
"""
All code below this part is involved in parsing the yaml configuration file (CONFIG FILE) 
which allows you to enter your arguments. The `config_get()` function should be used by 
outside classes to access this information.
"""


# Parse yaml config file
def parse_yaml_file(file_path: str) -> dict | None:
...
COLUMN_DATA = get_column_info_table(config_get('database'))


def column_variable_get(key: str):
